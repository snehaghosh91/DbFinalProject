...
$user = $_GET['id'];
$query = $conn->query("select * from follower where followeremail = '$user'");
$count_follow = $query->num_rows;
$sqlquery = $conn->query("select * from user where email = '$user'");
$row_user_details = $sqlquery->fetch_array();
?>
<div class="container">
  <hr>
  <hr>
  <h1><?php echo $row_user_details['firstname']." "; echo $row_user_details['lastname']; ?> follows -</h1>
  <hr>
    ...
    <div class="row">
     <div class="col-sm-12 col-sm-offset-0">
         ...
         {
            $follower = $row_followers['useremail'];
